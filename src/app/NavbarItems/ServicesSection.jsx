...
//     cache: 'no-store', // disable caching in dev, optional
//   });
...
const data=[
  ...
  return (
    <div className='grid grid-cols-12'>
        {
            data.map((item)=>{
                return <div className=' col-span-12 md:col-span-6 lg:col-span-4' key={item._id}>
                    <Image src={item.img} width={314} height={208} alt="services"/>
                    <h4>{item.name}</h4>
                    <h3>{item.price}</h3>
